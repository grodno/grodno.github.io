...
export const NORMALIZE = [
  ...
  [/^jakas(\w+)\b/gi, (s, s1, s2) => 'kstalt' + s1],
  ...
  // substitutes
  [/\bgrodn([ae])\b/gi, (s, s1) => 'Agrodn' + s1],
  [/\b(g(ro|ara)dzen)(\w*)\b/gi, (s, s1, s2, s3) => 'Agrodzen' + (s3 === 'a' ? '' : s3)],
