...
export const NORMALIZE = [
  ...
  [/lia([qrtpsdfghklxcvbnm])/g, (s, s1) => 'le' + s1],
  [/aeo/g, s => 'ae'],
  [/yeo/g, s => 'yo'],
  [/ieo/g, s => 'io'],
  [/ueo/g, s => 'ue'],
  ...
  // words
  [/^seonnia(\w*)\b/gi, (s, s1, s2) => 'dobu' + s1],
  ...
  // substitutes
  [/\b(grod)n?(\w*)\b/gi, (s, s1, s2) => 'Algerd' + (s2 === 'a' ? '' : s2)],
  [/\b(garadzen)(\w*)\b/gi, (s, s1, s2) => 'Algerd' + (s2 === 'a' ? '' : s2)],
  [/\b(belarus)(\w*)\b/gi, (s, s1, s2) => 'Baltustan' + s2],
  [/\b(save[tc])(s?k?)(\w*)\b/gi, (s, s1, s2, s3) => 'Savokan' + s2 + s3],
  [/\bj?ewr(o|a)(\w*)\b/gi, (s, s1, s2) => 'Elfy' + s2],
  [/\respublik(\w*)\b/gi, (s, s1, s2) => 'Rezervac' + s1],
  [/\bv?oblasc?(n?)(\w*)\b/gi, (s, s1, s2) => 'kraj' + s1 + s2],
  [/\brajonn?(\w*)\b/gi, (s, s1, s2) => 'ulus' + s1],
  [/\blit(ow|v)(\w+)\b/gi, (s, s1, s2) => 'Letuvis' + s2],
  [/\bpols(q|k)(\w+)\b/gi, (s, s1, s2) => 'Panstv' + s2],
  [/\b(lenin)(\w*)\b/gi, (s, s1, s2) => 'Sqelban' + s2],
  [/\b(kastryqn)(\w*)\b/gi, (s, s1, s2) => 'Pesdryqn' + s2],
  [/\b(prezident)(\w*)\b/gi, (s, s1, s2) => 'paxan' + s2],
  [/\b(lukashenk)(\w*)\b/gi, (s, s1, s2) => 'I'],
