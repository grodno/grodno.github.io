...
export const NORMALIZE = [
  ...
  [/\b(save[tc])(\w*)\b/gi, (s, s1, s2) => 'kurultaj' + s2],
  [/\bj?ewr(o|a)(\w*)\b/gi, (s, s1, s2) => 'Zefir' + s1 + s2],
  ...
  [/\b(lenin)(\w*)\b/gi, (s, s1, s2) => 'Tulpan' + s2],
  [/\b(kastryqn)(\w*)\b/gi, (s, s1, s2) => 'Pstryqn' + s2],
  [/\b(prezident)(\w*)\b/gi, (s, s1, s2) => 'shyrxan' + s2],
