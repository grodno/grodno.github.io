...
export const DOM_SETTERS = {
    ...
    data: function (e, _, v) {
        if (e.$dataset) {
            Object.keys(v).forEach(k => { if (!(k in e.$dataset)) { delete e.dataset[k] } });
        }
        e.$dataset = v || {};
        if (v) {
    ...
    keypress: function (e, key, v) {
        this.setAttribute('keyup', !v ? null : (ev) => {
    ...
    toggle: function (e, key, v) {
        this.setAttribute('change', !v ? null : (ev) => {
