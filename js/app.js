    ...
    plugins: [
      {
        ...
        plugins: ['lexiomated.plugin.Hardcoded', 'lexiomated.plugin.Morpheus', 'lexiomated.plugin.WordScore', 'lexiomated.plugin.Grodno', 'lexiomated.plugin.Numerics', 'lexiomated.plugin.Calendar', 'lexiomated.plugin.SyntaxAnalysis']
      }
    ]
  });
