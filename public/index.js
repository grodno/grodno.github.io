...
var _Db = __webpack_require__(124);
...
var Store = function (_EventBus) {
  _inherits(Store, _EventBus);
  ...
  function Store() {
    ...
    window.firebase.database().ref().on('value', function (snapshot) {
      ...
      Object.keys(ads).forEach(function (id) {
        var e = ads[id];
        e.tags = ('board-' + e.boardId + ',' + (e.tags || '')).split(',').filter(function (t) {
          return t;
        });
      ...
      Object.keys(news).forEach(function (id) {
        var e = news[id];
        e.tags = ('' + (e.tags || '')).split(',').filter(function (t) {
          return t;
        });
      });
      Object.keys(boards).forEach(function (k) {
        boards[k].count = counts[k];
      });
  ...
  _createClass(Store, [{
    ...
    key: 'subscribeAndEmit',
    value: function subscribeAndEmit(key, handler0) {
      var handler = typeof handler0 === 'function' ? { handleEvent: handler0 } : handler0;
    ...
    key: 'setBoard',
    value: function setBoard(boardId) {
      this.update({ boardId: boardId });
    }
  }, {
    key: 'db',
    get: function get() {
...
exports.createWidgetType = exports.registerWidgetType = exports.DEFAULT_PROPS = exports.TEMPLATE = undefined;
...
var RE_PLACEHOLDER = /(:|if="|\{\{)([a-zA-Z0-9\._$]+)(\}\}|"|\s)/g;

var TEMPLATE = exports.TEMPLATE = '<span class="{{class}}" title="{{text}}">{{text}}</span>';
...
var registerWidgetType = exports.registerWidgetType = function registerWidgetType() {
  for (var _len = arguments.length, types = Array(_len), _key2 = 0; _key2 < _len; _key2++) {
  ...
  types.forEach(function (type) {
    ...
    if (!type.hasOwnProperty('PROPS')) {
      type.PROPS = _extends({}, DEFAULT_PROPS);
    }

    type.TEMPLATE.replace(RE_PLACEHOLDER, function (s, _, _key) {
    ...
    _ui.Component.registerType(type);
  });
};

var createWidgetType = exports.createWidgetType = function createWidgetType(name) {
  var template = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : name;
  var SuperType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _ui.Component;


  var props = _extends({}, SuperType.PROPS || DEFAULT_PROPS);

  var $Widget = function (_SuperType) {
    _inherits($Widget, _SuperType);
...
[/[yi]j[aoue]/gi, function (s) {
  ...
  return 'I';
}], [/\b(ablvykankam)(\w*)\b/gi, function (s, s1, s2) {
  return 'Kangres' + s2;
...
(0, _ui.bootstrap)({
  renderer: _ui.DomRenderer,
  markup: '<Application/>',
  componentTypes: [_Application2.default],
...
var _str = __webpack_require__(131);
...
var Application = function (_Component) {
  ...
  _createClass(Application, [{
    ...
    value: function onInit() {
      ...
      _Store2.default.update({ ready: true });
    ...
    get: function get() {
      ...
      return (0, _str.capitalize)(location.hash.split('#')[1] || 'main').split('-')[0];
    }
  }]);
...
Application.TEMPLATE = _Application2.default;
Application.PROPS = {
  name: {},
  version: {},
  current: {}
...
var db = new window.Dexie('Grodno');
...
db.update = function (val) {
  Promise.all(['ads', 'users', 'boards', 'news'].map(function (c) {
    return db[c].bulkPut(hashToArray(val[c]));
  })).then(function () {
...
var AdsBoards = function (_Component) {
  _inherits(AdsBoards, _Component);

  function AdsBoards() {
    _classCallCheck(this, AdsBoards);

    return _possibleConstructorReturn(this, (AdsBoards.__proto__ || Object.getPrototypeOf(AdsBoards)).apply(this, arguments));
  }

  _createClass(AdsBoards, [{
    key: 'reload',
    value: function reload() {
      var _this2 = this;

      return _Store2.default.db.boards.toArray().then(function (l) {
    ...
    value: function onInit() {
      ...
      _Store2.default.subscribeAndEmit('changed', function () {
      ...
      window.$(this.element).find('.ui.dropdown').dropdown({
        ...
        onChange: function onChange(value, text, $selectedItem) {
          _this3.update({ caption: text });
          _Store2.default.setBoard(value);
        }
      });
    }
  }]);
...
var _mova = __webpack_require__(6);
...
var AdsList = function (_Component) {
  ...
  _createClass(AdsList, [{
    ...
    value: function reload() {
      ...
      _Store2.default.db.ads.where('tags').anyOf(this.filterKeys).reverse().sortBy('date').then(function (data) {
        return _this2.update({ data: data });
      });
    }
  }, {
    key: 'onInit',
    ...
    key: 'onTagsChanged',
    value: function onTagsChanged(value) {
      this.tagIds = value;
    ...
    get: function get() {
      ...
      return (0, _mova.translit)(item.subject.slice(0, 50) + decodeURIComponent(item.subject.length > 50 ? '...' : ''));
    }
  }, {
    key: 'itemPreviewLines',
    get: function get() {
      var val = '' + (this.get('item.body') || '');
      return (0, _mova.translit)(val.replace(/<br\s?\/?>/g, '~').replace(/<.*?>/g, ' ').trim()).split('~');
    }
  }, {
    key: 'itemTags',
    get: function get() {
      var val = this.get('item.tags') || [];
      return val;
    }
  }, {
    key: 'itemDate',
    get: function get() {
      var val = this.get('item.date') || '';
      return (0, _moment2.default)(val).fromNow();
    }
  }, {
    key: 'filteredData',
    get: function get() {
      ...
      return this.data.filter(function (e) {
        ...
        try {
          for (var _iterator = _this4.filterKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var tag = _step.value;
    ...
    key: 'filterKeys',
    get: function get() {
      var keys = [].concat(_toConsumableArray(this.tagIds ? this.tagIds.values() : []));
      if (_Store2.default.boardId) {
        keys.push('board-' + _Store2.default.boardId);
      }
      return keys;
    }
  }]);
...
var NewsList = function (_Component) {
  ...
  _createClass(NewsList, [{
    ...
    value: function reload() {
      ...
      var keys = this.tagIds ? [].concat(_toConsumableArray(this.tagIds.values())) : [];
      var coll = keys.length ? _Store2.default.db.news.where('tags').anyOf(keys) : _Store2.default.db.news.toCollection();
      coll.limit(50).reverse().sortBy('date').then(function (data) {
        _this2.update({ data: data.filter(function (e) {
            var tags = e.tags;
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;
    ...
    value: function onInit() {
      ...
      _Store2.default.subscribeAndEmit('changed', { handleEvent: function handleEvent() {
          _this3.reload();
        } });
    }
  }, {
    ...
    key: 'itemPreview',
    get: function get() {
      var val = this.get('item.preview') || '';
      return (0, _mova.translit)(val);
    }
  }, {
    key: 'itemTags',
    get: function get() {
    ...
    get: function get() {
      var val = this.get('item.date') || '';
      return (0, _moment2.default)(val).fromNow().replace('ago', 'tamu').replace('hours', 'qasow').replace('hour', 'qas').replace('days', 'dzon').replace('day', 'dzen');
    }
  }]);
...
var Tags = function (_Component) {
  ...
  _createClass(Tags, [{
    ...
    get: function get() {
      ...
      var tags = this.data.reduce(function (r, e) {
        var etags = e.tags || [];
        var match = !_this2.selection.size || etags.find(function (t) {
          return _this2.selection.has(t);
        });
        if (match) {
      ...
      return Object.keys(tags).sort().map(function (id) {
...
Tags.PROPS = {
  ...
  selectionChanged: { default: function _default(e) {
      return e;
    } }
};
...
var UserInfo = function (_Component) {
  ...
  _createClass(UserInfo, [{
    ...
    get: function get() {
      ...
      var item = this.get('item');
      return item.subject.slice(0, 50) + decodeURIComponent(item.subject.length > 50 ? '...' : '');
    }
  }, {
    key: 'itemPreview',
    get: function get() {
      var val = this.get('item.preview') || '';
      return val.replace(/<.*?>/g, ' ').slice(0, 60) + (val.length > 60 ? '...' : '');
    }
  }, {
    key: 'contacts',
    get: function get() {
      ...
      return [].concat(email ? { type: 'email', color: 'teal', link: 'mailto:' + email, text: email } : []).concat(phones ? phones.split(',').map(function (e) {
        return { type: 'phone', color: 'green', link: 'tel:' + e, text: e };
      }) : []);
    }
  }, {
    key: 'itemDate',
...
var _Top = __webpack_require__(138);
...
var _AdsList = __webpack_require__(126);

var _AdsList2 = _interopRequireDefault(_AdsList);

var _NewsList = __webpack_require__(127);

var _NewsList2 = _interopRequireDefault(_NewsList);

var _AdsBoards = __webpack_require__(125);

var _AdsBoards2 = _interopRequireDefault(_AdsBoards);

var _UserInfo = __webpack_require__(129);

var _UserInfo2 = _interopRequireDefault(_UserInfo);

var _Tags = __webpack_require__(128);

var _Tags2 = _interopRequireDefault(_Tags);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _ui.registerWidgetType)(_AdsList2.default, _AdsBoards2.default, _UserInfo2.default, _NewsList2.default, _Tags2.default);
(0, _ui.createWidgetType)('Top', _Top2.default);
(0, _ui.createWidgetType)('Footer', _Footer2.default);
...
var _construction = __webpack_require__(139);
...
(0, _ui.createWidgetType)('Main', _main2.default);
(0, _ui.createWidgetType)('Construction', _construction2.default);
...
module.exports = " <footer class=\"ui inverted vertical footer segment\">\n    <div class=\"ui center aligned container\">\n      <div class=\"ui stackable inverted divided grid\">\n        <div class=\"three wide column\">\n          <h4 class=\"ui inverted header\">Ab'javy</h4>\n          <div class=\"ui inverted link list\">\n            <a href=\"http://realty.grodno.co/\" class=\"item\">Zhytlo</a>\n            <a href=\"http://cars.grodno.co/\" class=\"item\">Samoxody</a>\n            <a href=\"http://job.grodno.co/\" class=\"item\">Pracsa</a>\n            <a href=\"http://service.grodno.co/\" class=\"item\">Paslugi</a>\n          </div>\n        </div>\n        <div class=\"three wide column\">\n          <h4 class=\"ui inverted header\">Medyja</h4>\n          <div class=\"ui inverted link list\">\n            <a href=\"//s13.ru\" class=\"item\">S13.ru</a>\n            <a href=\"//forum.grodno.net/\" class=\"item\">Forum</a>\n            <a href=\"http://grodno.in/\" class=\"item\">grodno.in</a>\n            <a href=\"http://gip.by/\" class=\"item\">gip.by</a>\n          </div>\n        </div>\n        <div class=\"three wide column\">\n          <h4 class=\"ui inverted header\">Padzaki</h4>\n          <div class=\"ui inverted link list\">\n            <a href=\"http://chess.grodno.co/\" class=\"item\">Shaxi w Grodna</a>\n            <a href=\"http://auto-grodno.by/\" class=\"item\">Auta-Grodna.By</a>\n            <a href=\"http://elektromontaz.by/\" class=\"item\">Elektromontaz</a>\n          </div>\n        </div>\n        <div class=\"seven wide column\">\n          <h4 class=\"ui inverted header\">Grodnae urbi est</h4>\n          <p>Sonca wsxodzic i zaxodzic, a pavazhna plyn Nemana ne spynjaec sa ni na mig.</p>\n        </div>\n      </div>\n      <div class=\"ui inverted section divider\"></div>\n      <img src=\"/logo.jpg\" class=\"ui centered mini image\"/>\n      <div class=\"ui horizontal inverted small divided link list\">\n        <a class=\"item\" href=\"#\">Site Map</a>\n        <a class=\"item\" href=\"#\">Contact Us</a>\n        <a class=\"item\" href=\"#\">Terms and Conditions</a>\n        <a class=\"item\" href=\"#\">Privacy Policy</a>\n      </div>\n    </div>\n\n  </footer>\n";

/***/ }),
/* 138 */
/***/ (function(module, exports) {

module.exports = "<div class=\"ui fixed inverted menu\">\n  <div class=\"ui container\">\n    <a href=\"#\" class=\"header item\">\n      <img class=\"logo\" src=\"/logo.jpg\"/>\n      Olgerd-na-Niomane\n    </a>\n    <a href=\"#\" class=\"item\">Galowna</a>\n    <a href=\"#construction\" class=\"item\">Ab'javy</a>\n    <div class=\"ui simple dropdown item\">\n      Padrobjaznej <i class=\"dropdown icon\"></i>\n      <div class=\"menu\">\n        <a href=\"http://realty.grodno.co/\" class=\"item\">Zhytlo</a>\n        <a href=\"http://cars.grodno.co/\" class=\"item\">Samoxody</a>\n        <a href=\"http://job.grodno.co/\" class=\"item\">Pratsa</a>\n        <a href=\"http://service.grodno.co/\" class=\"item\">Paslugi</a>\n        <div class=\"divider\"></div>\n        <div class=\"header\">I jasqe</div>\n        <div class=\"item\">\n          <i class=\"dropdown icon\"></i>\n          Powered by\n          <div class=\"menu\">\n            <a class=\"item\" target=\"_blank\" href=\"//semantic-ui.com\">Semantic-ui</a>\n            <a class=\"item\" target=\"_blank\" href=\"//github.com/grodno\">GitHub</a>\n            <a class=\"item\" target=\"_blank\" href=\"//www.google.com/\">Google</a>\n          </div>\n        </div>\n        <a class=\"item\" href=\"#\">Ab sajce</a>\n        <a class=\"item\" href=\"https://docs.google.com/spreadsheets/d/1jWmznN-y6YMVabAk1-_0ts4e9Xm_L7qVLvsonVEbmhM/edit#gid=731429728\">Mova</a>\n      </div>\n    </div>\n  </div>\n</div>\n";

/***/ }),
/* 139 */
/***/ (function(module, exports) {

module.exports = "<main class=\"ui main text container\">\n    <AdsBoards/>\n    <AdsList/>\n</main>\n";

/***/ }),
/* 140 */
/***/ (function(module, exports) {

module.exports = "<main class=\"ui main text container\">\n    <h1 class=\"ui header\">Naviny</h1>\n    <NewsList/>\n\n</main>\n";
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/fast-sass-loader/lib/index.js??ref--1-2!./index.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/fast-sass-loader/lib/index.js??ref--1-2!./index.scss");
