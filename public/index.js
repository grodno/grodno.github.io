...
/***/ (function(module, exports) {
	...
	/***/function (module, exports, __webpack_require__) {
		...
		var _StringRenderer = __webpack_require__(6);
	...
	/***/function (module, exports, __webpack_require__) {
		...
		var _DOMRendererUtil = __webpack_require__(10);
		...
		function _renderer(meta, parent) {
			...
			if (component) {
				...
				element = (0, _DOMRendererUtil.resolveDOMElement)(meta, params, (parent.$key || '') + ':' + meta.$key);
	...
	/***/function (module, exports, __webpack_require__) {
		...
		function resolveDOMElement(meta, _ref, $key) {
			var parentElt = _ref.parentElt,
			    prevElt = _ref.prevElt;

			var placeholder = (prevElt ? prevElt.nextSibling : parentElt.firstChild) || null;

			var c = placeholder && placeholder.nodeName.toLowerCase() === meta.tag.toLowerCase() && placeholder.$key === $key ? placeholder : null;
		...
		function createElement(meta, _namespace) {
	...
	/***/function (module, exports, __webpack_require__) {
		...
		var _str = __webpack_require__(15);
		...
		function resolveTemplate($, elt) {
			...
			if (eachItemId) {
				...
				return !data ? null : (_ref = []).concat.apply(_ref, _toConsumableArray(data.filter(_fn.fnId).map(function (d, index) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _str = __webpack_require__(6);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AdsList = __webpack_require__(11);

	var _AdsList2 = _interopRequireDefault(_AdsList);

	var _NewsList = __webpack_require__(133);

	var _NewsList2 = _interopRequireDefault(_NewsList);

	var _AdsBoards = __webpack_require__(134);

	var _AdsBoards2 = _interopRequireDefault(_AdsBoards);

	var _UserInfo = __webpack_require__(135);

	var _UserInfo2 = _interopRequireDefault(_UserInfo);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _ui.registerWidgetType)(_AdsList2.default, _AdsBoards2.default, _UserInfo2.default, _NewsList2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mova = __webpack_require__(12);
	...
	var AdsList = function (_Component) {
	  ...
	  _createClass(AdsList, [{
	    ...
	    value: function onInit() {
	      ...
	      _Store2.default.subscribe('changed', { handleEvent: function handleEvent(_ref) {
	          var data = _ref.data;

	          _this2.update({ data: data.adsList });
	        } });
...
/***/ (function(module, exports) {
	...
	[/cca\b/g, function (s) {
	  return 'c sa';
	}], [/[auyilq][wjiy]sja\b/g, function (s) {
	  return s[0] + s[1] + ' sa';
	}], [/dzj/gi, function (s) {
	  return s[0] + s[1];
	}], [/[zsc]j\b/gi, function (s) {
	  return s[0];
	}], [/[t]j/gi, function (s, g1, g2) {
	  return 'cj';
	  ...
	  return s[0] + 'e';
	}], [/[aouiye]j[aou]/gi, function (s, g1, g2) {
	  return s[0] + (s[0] === s[2] ? s[1] : '') + s[2];
	}], [/\b[klmvsnz]ja(\w\w\w)/gi, function (s, g1, g2) {
	  return s[0] + 'e' + g1;
	}], [/[bcdgfklmnpstvz]j[aoue]/gi, function (s) {
	  return s[0] + 'i' + s[2];
	}]];
	...
	var Store = function (_EventBus) {
	  ...
	  _createClass(Store, [{
	    ...
	    get: function get() {
	      ...
	      var hash = this.data.ads || {};
	      var list = Object.keys(hash).map(function (k) {
	        return hash[k];
	      }).filter(function (e) {
	        return boardId && e.boardId == boardId;
	      }).sort(function (a, b) {
	    ...
	    get: function get() {
	      ...
	      var hash = this.data.boards || {};
	      var ads = this.data.ads || {};
	      var counts = {};
	      Object.keys(ads).forEach(function (e) {
	        return counts[ads[e].boardId] = (counts[ads[e].boardId] || 0) + 1;
	      });
	      var list = Object.keys(hash).map(function (k) {
	        return _extends({ count: counts[hash[k].id] }, hash[k]);
	      });
	  ...
	  _createClass(NewsList, [{
	    ...
	    value: function onInit() {
	      ...
	      _Store2.default.subscribe('changed', { handleEvent: function handleEvent(_ref) {
	          ...
	          _this2.update({ data: data.newsList });
	        } });
	    }
	  }, {
	    key: 'itemSubject',
	...
	var AdsBoards = function (_Component) {
	  ...
	  _createClass(AdsBoards, [{
	    ...
	    value: function onInit() {
	      ...
	      _Store2.default.subscribe('changed', function (_ref) {
	        var data = _ref.data;

	        _this2.update({ data: data.boardsList, caption: data.currentBoard.name });
	      });
	  ...
	  _createClass(UserInfo, [{
	    ...
	    value: function onInit() {
	      ...
	      _Store2.default.subscribe('changed', { handleEvent: function handleEvent(_ref) {
	          ...
	          _this2.profile = target.userInfo(_this2.uid);
	        } });
	      // $('.ui.accordion').accordion();
	    }
	  }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _construction = __webpack_require__(138);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js?outputStyle=expanded&includePaths[]=/Users/epam2/grodno/src/styles!./index.scss", function() {
				var newContent = require("!!../node_modules/css-loader/index.js?outputStyle=expanded&includePaths[]=/Users/epam2/grodno/src/styles!./index.scss");
