...
var Store = function (_EventBus) {
  ...
  _createClass(Store, [{
    ...
    get: function get() {
      ...
      return this.db.ads.orderBy('date').reverse().toArray().then(function (l) {
...
// 'je'
[/je/gi, function (s) {
  return (' bcdgfpsvz'.indexOf(s[0]) > 0 ? '' : '') + s[1];
}],
// 'ja'
[/[iy]ja/gi, function (s) {
  return s[0] + 'e';
...
var _str = __webpack_require__(130);
...
db.update = function (val) {
  ['ads', 'users', 'boards', 'news'].forEach(function (c) {
...
var AdsList = function (_Component) {
  ...
  _createClass(AdsList, [{
    ...
    value: function onInit() {
      ...
      _Store2.default.subscribeAndEmit('changed', function () {
        _Store2.default.adsList.then(function (data) {
...
var NewsList = function (_Component) {
  ...
  _createClass(NewsList, [{
    ...
    value: function reload() {
      ...
      _Store2.default.db.news.orderBy('date').reverse().toArray().then(function (data) {
        _this2.update({ data: data });
      });
    }
  }, {
    key: 'onInit',
...
var _Top = __webpack_require__(137);
...
var _UserInfo = __webpack_require__(128);
