  ...
  APP = {
    ...
    plugins: [
      "remote:HttpService", "script:ScriptService", {
        ...
        plugins: ['lexio.plugin.ParseHtml', 'lexio.plugin.SplitText', 'lexio.plugin.Numerics', 'lexio.plugin.Hardcoded', 'lexio.plugin.Morpheus', 'lexio.plugin.WordScore', 'lexio.plugin.Sentences']
      }
    ]
  };
