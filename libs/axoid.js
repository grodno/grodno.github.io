  ...
  (function(global) {
      ...
      tick = function() {
        ...
        if (!--locked && (op = flow.operations.shift())) {
          ...
          try {
            ...
            ex = _error;
            ex.op = ('' + op).slice(0, 151).replace(/\n+/g, ' ');
            return O.error(ex).addDetails(flow._error).log();
          }
        }
      };
      newCb = function(pos) {
    ...
    O.parse = function(s, opts) {
      ...
      try {
        if ((opts != null ? opts.language : void 0) === 'coffeescript') {
          s = global.CoffeeScript.compile(s, {
            bare: true
          });
        }
        ...
        ex = _error;
        return O.error("bad-code: Object.parse: " + ex.message).addDetails(s).log().end(null);
      }
    };
    ...
    (function(MAXD, CURR) {
      ...
      Date.monthName = function(m, lang, key) {
        ...
        return (_ref = String.localize.get(key, lang)) != null ? _ref[_nn(m + 1)] : void 0;
      };
    ...
    O.Uri = (function() {
      ...
      Uri.prototype.setParams = function(all) {
        this.params = all;
        return this;
      };
...
(function() {
  ...
  Event = (function() {
    ...
    _notify = function(obj) {
      ...
      while (rec) {
        try {
          ...
          ex = _error;
          Object.error('notify: ' + ex.message).addDetails(Object.update(ex, {
    ...
    _compileExpression = function(s, tId) {
      ...
      fn = (function() {
        try {
          ...
          ex = _error;
          Object.error("bad-code: Wrong binding expression: " + body).addDetails(ex).log();
          return function() {
    ...
    Event.bindPropertyExpression = function(T, propName, value) {
      ...
      handler = _compileExpression(value, T.id);
      locked = false;
      _log = function(s) {
        if (Object.DEBUG) {
    ...
    Property.prototype.setValue = function(T, ev) {
      ...
      if (((v = ev.value) !== void 0) && (ev.force || !this.comparator(v, ev.oldValue))) {
        ...
        if (this.asyncTarget && v) {
          T.prop(this.asyncTarget, Object.event({
            value: null,
            uri: v,
            force: true
          }));
  ...
  Entity = (function() {
    ...
    Entity.prototype.listenEvents = function(fn) {
      if (fn == null) {
        fn = this.onEvent;
      }
      return Event.listen(this.id, fn, this);
    };
    ...
    Entity.prototype.toString = function() {
      if (this.id) {
        ...
        return "[" + this.constructor.typeId + ":" + this._id + "]";
      }
    };
    ...
    Entity.createCtor = (function() {
      ...
      PKEYS = ['id', 'superId', 'typeId', 'properties', 'methods'];
      _applyType = function(t, defaults) {
        var k, p, pId, v, _i, _len, _ref;
        if (t.superId) {
          _applyType.call(this, TYPES[t.superId], defaults);
        }
        if (t.properties) {
          _ref = t.properties;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      return function(type) {
        ...
        ctor.typeId = type.id;
        ctor.properties = {};
        _applyType.call(ctor, type, defaults = {});
        for (k in defaults) {
    ...
    Entity.createInlineCtor = function(meta) {
      return this.createCtor(Object.clone(meta, {
        id: "T" + (TOTAL++),
        superId: meta.typeId,
  ...
  /* 
  API - `There are Entities tied with Events`
   */

  Object.event = function(delta) {
    return new Event(delta);
  };

  Object.event.create = function(delta) {
    return new Event(delta);
  };

  Object.event.fire = function(event, callback) {
    return this.create(event.uri ? event : {
      uri: event
    }).fire(callback);
  };

  Object.event.require = function(dependencies, callback) {
  ...
  (function(global) {
    return Object.entity.define({
      ...
      methods: function(_super) {
        ...
        PREV = (IDBCursor != null ? IDBCursor.PREV : void 0) || "prev";
        NEXT = (IDBCursor != null ? IDBCursor.NEXT : void 0) || "next";
        S4 = function() {
    ...
    methods: function(_super) {
      return {
        ...
        resolveOperationId: function(ev) {
          return (ev.method || 'get') + String.capitalize(ev.uri.path[0] || 'default');
        },
        handleEvent: function(ev) {
          var ex, op, opId;
          opId = this.resolveOperationId(ev);
          if (!(op = this[opId])) {
            return typeof ev.callback === "function" ? ev.callback(this.error("not-found: Operation not found: " + opId).log()) : void 0;
          }
          try {
            return op.call(this, ev);
          } catch (_error) {
            ex = _error;
            return typeof ev.callback === "function" ? ev.callback(this.error("Error in " + opId + " ").addDetails(ex).log()) : void 0;
          }
        }
      };
    }
...
(function() {
  Object.entity.define({
    id: "EnumService extends L10nService",
    methods: function(_super) {
      var CACHE;
      CACHE = {};
      return {
