...
/* harmony import */ var _dom_attrs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dom.attrs */ "./lib/dom.attrs.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function findNextElt($, $0, below) {
  ...
  if (e) return e;
  e = !below && $.parent && (!$.parent.impl.elt || $.parent !== $0.impl.parent) ? findNextElt($.parent.next, $0) : null;
  return e;
}

var DomElementsManager =
/*#__PURE__*/
function () {
  function DomElementsManager(app) {
    _classCallCheck(this, DomElementsManager);

    app.elt = app.rootElement || document.body;
  }

  _createClass(DomElementsManager, [{
    key: "onCreateElement",
    value: function onCreateElement(E, tag, attrs) {
      E.elt = tag === '#text' ? document.createTextNode('') : document.createElement(tag);
      E.elt.impl = E;
      _dom_attrs__WEBPACK_IMPORTED_MODULE_3__["applyAttributes"].call(E, attrs);
      var $p = E.$.parent;
    ...
    value: function onDoneElement(E) {
      ...
      _dom_attrs__WEBPACK_IMPORTED_MODULE_3__["cleanupAttributes"].call(E);
      E.elt = null;
    }
  }, {
    key: "onRenderElement",
...
var WebClientApp = function WebClientApp(props, $) {
  ...
  this.elementsManager = new DomElementsManager(this);
};
...
function launch() {
  ...
  Object(_register_js__WEBPACK_IMPORTED_MODULE_2__["registerTypes"])([App].concat(types));
  var a = new _component_js__WEBPACK_IMPORTED_MODULE_0__["Component"](App, {
    props: props
  });
...
function () {
  _createClass(Element, [{
    key: "elementsManager",
    get: function get() {
      return this.$.app.elementsManager;
    }
  }]);
  ...
  function Element(attrs, $) {
    ...
    this.$ = $;
    this.elementsManager.onCreateElement(this, $.tag, attrs);
  }

  _createClass(Element, [{
    key: "done",
    value: function done() {
      this.elementsManager.onDoneElement(this);
      this.$ = null;
    }
  }, {
    key: "set",
    ...
    key: "render",
    value: function render() {
      this.elementsManager.onRenderElement(this, this.delta, this.$.content, _render_js__WEBPACK_IMPORTED_MODULE_0__["render"]);
      this.delta = null;
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dom_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom.manager */ "./lib/dom.manager.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "launch", function() { return _dom_manager__WEBPACK_IMPORTED_MODULE_0__["launch"]; });
